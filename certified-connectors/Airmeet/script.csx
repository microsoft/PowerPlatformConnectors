public class Script : ScriptBase
{
    ...
    private async Task UpdateRequest()
    {
        ...
        this.Context.Request.Headers.TryGetValues("x-access-key", out var airmeetAccessKey);
        this.Context.Request.Headers.TryGetValues("x-secret-key", out var airmeetSecretKey);
        using var userInfoRequest = new HttpRequestMessage(HttpMethod.Post, "https://api.airmeet.com/api/v1/auth");
