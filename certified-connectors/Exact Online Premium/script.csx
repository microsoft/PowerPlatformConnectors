...
public static class SchemaHelper
{
    ...
    private static readonly string[] AccountFields = new[] { "sBusinessComponent", "sEntityEvent",
        "sAccountant","sAccountantAccountManager","sAccountantAccountManagerFullName","sAccountManager","sAccountManagerFullName","sAccountManagerHID","sActivitySector",
        "sActivitySectorDescription","sActivitySectorParent","sActivitySubSector","sActivitySubSectorDescription","sActivitySubSectorParent","sAddressLine1",
        "sAddressLine2","sAddressLine3","iAnonymisationSource","bAutomaticProcessProposedEntry","sBankAccountCountry","sBankAccountCountryDescription","bBlocked","sBRIN",
        "sBRINName","sBusinessType","sBusinessTypeDescription","bCanDropShip","sChamberOfCommerce","sChamberOfCommerceEstablishment","sCity","sClassification",
        "sClassification1","sClassification1Description","sClassification1Name","sClassification2","sClassification2Description","sClassification2Name",
        "sClassification3","sClassification3Description","sClassification3Name","sClassification4","sClassification4Description","sClassification4Name",
        "sClassification5","sClassification5Description","sClassification5Name","sClassification6","sClassification6Description","sClassification6Name",
        "sClassification7","sClassification7Description","sClassification7Name","sClassification8","sClassification8Description","sClassification8Name",
        "sClassificationDescription","iCode","sCodeAtSupplier","sCompanySize","sCompanySizeDescription","iConsolidationScenario","sControlledDate","sCostcenter",
        "sCostcenterDescription","bCostPaid","sCountry","sCountryDescription","dCreated","gCreator","sCreatorFullName","nCreditLinePurchase","nCreditLineSales",
        "sCreditManagementScenario","sCreditManagementStatus","sCreditManagementStatusCode","sCreditManagementStatusDescription","sCurrency","sCustomerSince","sDateModifiedByCoC",
        "sDefaultApprover","sDefaultApproverFullName","nDiscountPurchase","nDiscountSales","iDivision","sDivisionDescription","sDocument","sDocumentHID","sDocumentSubject",
        "sDunsNumber","sEmail","sEndDate","sEstablishedDate","gExtension","sFax","sGLAccountPurchase","sGLAccountPurchaseCode","sGLAccountPurchaseDescription",
        "sGLAccountSales","sGLAccountSalesCode","sGLAccountSalesDescription","sGLAP","sGLAPCode","sGLAPDescription","sGLAR","sGLARCode","sGLARDescription","sGlnNumber",
        "gID","sIntraStatArea","sIntraStatDeliveryTerm","sIntraStatSystem","sIntraStatTransactionA","sIntraStatTransactionB","sIntraStatTransportMethod",
        "sInvoiceAccount","sInvoiceAccountCode","sInvoiceAccountName","iInvoiceAttachmentType","iInvoicingMethod","bIsAccountant","bIsAgency","bIsAnonymized","bIsBank",
        "bIsCheckOverdueInvoices","bIsCompetitor","bIsMailing","bIsMember","bIsPilot","bIsPurchase","bIsReseller","bIsSales","bIsSupplier","sLaborMarkupPercentage",
        "sLanguage","sLanguageDescription","sLatitude","sLeadPurpose","sLeadPurposeDescription","sLeadSource","sLeadSourceDescription","sLogoFileName","sLongitude","sMainContact",
        "dModified","gModifier","sModifierFullName","sName","sOBNumber","sOINNumber","sParent","sParentCode","sParentName","sPaymentConditionPurchase",
        "sPaymentConditionPurchaseDescription","sPaymentConditionSales","sPaymentConditionSalesDescription","sPeppolIdentifier","sPhone","sPhoneExtension",
        "sPostcode","sPriceList","sProfitPercentage","sPurchaseCurrency","sPurchaseCurrencyDescription","iPurchaseLeadDays","sPurchaseMarkupPercentage",
        "sPurchaseMarkupPercentageProject","iPurchaseOrderAttachmentType","sPurchaseVATCode","sPurchaseVATCodeDescription","sQuotationMarkupType","bRecepientOfCommissions",
        "sRemarks","sReminderFlowCategory","sReseller","sResellerCode","sResellerName","sRSIN","sSalesCurrency","sSalesCurrencyDescription","sSalesVATCode","sSalesVATCodeDescription",
        "sSBICode","sSbiCodeDescription","sSbiCodeSector","sSbiCodeSubSector","sSDK_LoyalPr_Ref_Account_AccountCode","sSDK_LoyalPr_Ref_Contact_ContactPerson",
        "sSDK_LoyalPr_Ref_Item_ItemCode","sSDK_LoyalPr_Ref_Opportunity_OpportunityName","sSDK_LoyalPr_Ref_Project_ProjectCode","sSDK_LoyalPr_Ref_SalesOrder_SalesOrderHeaderDescription",
        "sSDK_LoyalPrAccount","sSDK_LoyalPrContact","sSDK_LoyalPrItem","sSDK_LoyalPrLoyaltyCard","sSDK_LoyalPrLoyaltyCardValidity","sSDK_LoyalPrLoyaltyDiscount","iSDK_LoyalPrLoyaltyLevel",
        "bSDK_LoyalPrLoyaltyMember","sSDK_LoyalPrOpportunity","sSDK_LoyalPrProject","sSDK_LoyalPrSalesOrder","sSDK_LoyalPrSalesOrder_SalesOrderNumber","sSearchCode",
        "iSecurityLevel","iSendPurchaseOrderMethod","sSepaDDCreditorIdentifier","bSeparateInvPerProject","bSeparateInvPerSubscription","iShippingLeadDays","sShippingMethod",
        "sShippingMethodCode","sShippingMethodDescription","sSirenNumber","iSource","dStartDate","sState","sStateDisplayValue","sStateName","sStatus","dStatusSince","sTaxReferenceNumber",
        "sTradeName","sType","bUseTimeSpecification","sVATLiability","sVATNumber","sVatSystem","sViesLastCalledDate","bViesResult","sWebsite","sWithholdingTaxDescription","sWithholdingTaxKey"
    };

    private static readonly string[] OpportunityFields = new[] { "sBusinessComponent", "sEntityEvent",
        "sAccountant","sAccountantAccountManager","sAccountantAccountManagerFullName","sAccountManager","sAccountManagerFullName","sAccountManagerHID","gActivitySector",
        "sActivitySectorDescription","sActivitySectorParent","gActivitySubSector","sActivitySubSectorDescription","gActivitySubSectorParent",
        "sAddressLine1","sAddressLine2","sAddressLine3","iAnonymisationSource","bAutomaticProcessProposedEntry","sBankAccountCountry","sBankAccountCountryDescription",
        "bBlocked","sBRIN","sBRINName","gBusinessType","sBusinessTypeDescription","bCanDropShip","sChamberOfCommerce","sChamberOfCommerceEstablishment","sCity",
        "sClassification","sClassification1","sClassification1Description","sClassification1Name","sClassification2","sClassification2Description","sClassification2Name",
        "sClassification3","sClassification3Description","sClassification3Name","sClassification4","sClassification4Description","sClassification4Name",
        "sClassification5","sClassification5Description","sClassification5Name","sClassification6","sClassification6Description","sClassification6Name",
        "sClassification7","sClassification7Description","sClassification7Name","sClassification8","sClassification8Description","sClassification8Name",
        "sClassificationDescription","sCode","sCodeAtSupplier","gCompanySize","sCompanySizeDescription","iConsolidationScenario","dControlledDate","sCostcenter",
        "sCostcenterDescription","bCostPaid","sCountry","sCountryDescription","dCreated","gCreator","sCreatorFullName","nCreditLinePurchase","nCreditLineSales",
        "sCreditManagementScenario","sCreditManagementStatus","sCreditManagementStatusCode","sCreditManagementStatusDescription","sCurrency","dCustomerSince",
        "dDateModifiedByCoC","sDefaultApprover","sDefaultApproverFullName","nDiscountPurchase","nDiscountSales","iDivision","sDivisionDescription","sDocument","sDocumentHID",
        "sDocumentSubject","sDunsNumber","sEmail","dEndDate","dEstablishedDate","gExtension","sFax","sGLAccountPurchase","sGLAccountPurchaseCode","sGLAccountPurchaseDescription",
        "sGLAccountSales","sGLAccountSalesCode","sGLAccountSalesDescription","sGLAP","sGLAPCode","sGLAPDescription","sGLAR","sGLARCode","sGLARDescription","sGlnNumber","gID",
        "sIntraStatArea","sIntraStatDeliveryTerm","sIntraStatSystem","sIntraStatTransactionA","sIntraStatTransactionB","sIntraStatTransportMethod","sInvoiceAccount",
        "sInvoiceAccountCode","sInvoiceAccountName","iInvoiceAttachmentType","iInvoicingMethod","bIsAccountant","bIsAgency","bIsAnonymized","bIsBank","bIsCheckOverdueInvoices",
        "bIsCompetitor","bIsMailing","bIsMember","bIsPilot","bIsPurchase","bIsReseller","bIsSales","bIsSupplier","sLaborMarkupPercentage","sLanguage","sLanguageDescription",
        "sLatitude","sLeadPurpose","sLeadPurposeDescription","sLeadSource","sLeadSourceDescription","sLogoFileName","sLongitude","gMainContact","dModified","gModifier",
        "sModifierFullName","sName","sOBNumber","sOINNumber","sParent","sParentCode","sParentName","sPaymentConditionPurchase","sPaymentConditionPurchaseDescription",
        "sPaymentConditionSales","sPaymentConditionSalesDescription","sPeppolIdentifier","sPhone","sPhoneExtension","sPostcode","sPriceList","sProfitPercentage",
        "sPurchaseCurrency","sPurchaseCurrencyDescription","iPurchaseLeadDays","sPurchaseMarkupPercentage","sPurchaseMarkupPercentageProject","iPurchaseOrderAttachmentType",
        "sPurchaseVATCode","sPurchaseVATCodeDescription","sQuotationMarkupType","bRecepientOfCommissions","sRemarks","sReminderFlowCategory","sReseller","sResellerCode",
        "sResellerName","sRSIN","sSalesCurrency","sSalesCurrencyDescription","sSalesVATCode","sSalesVATCodeDescription","sSBICode","sSbiCodeDescription","sSbiCodeSector",
        "sSbiCodeSubSector","sSDK_LoyalPr_Ref_Account_AccountCode","sSDK_LoyalPr_Ref_Contact_ContactPerson","sSDK_LoyalPr_Ref_Item_ItemCode",
        "sSDK_LoyalPr_Ref_Opportunity_OpportunityName","sSDK_LoyalPr_Ref_Project_ProjectCode","sSDK_LoyalPr_Ref_SalesOrder_SalesOrderHeaderDescription","sSDK_LoyalPrAccount",
        "sSDK_LoyalPrContact","sSDK_LoyalPrItem","sSDK_LoyalPrLoyaltyCard","sSDK_LoyalPrLoyaltyCardValidity","sSDK_LoyalPrLoyaltyDiscount","iSDK_LoyalPrLoyaltyLevel",
        "bSDK_LoyalPrLoyaltyMember","sSDK_LoyalPrOpportunity","sSDK_LoyalPrProject","sSDK_LoyalPrSalesOrder","sSDK_LoyalPrSalesOrder_SalesOrderNumber","sSearchCode",
        "iSecurityLevel","iSendPurchaseOrderMethod","sSepaDDCreditorIdentifier","bSeparateInvPerProject","bSeparateInvPerSubscription","iShippingLeadDays","sShippingMethod",
        "sShippingMethodCode","sShippingMethodDescription","sSirenNumber","sSource","dStartDate","sState","sStateDisplayValue","sStateName","sStatus","dStatusSince",
        "sTaxReferenceNumber","sTradeName","sType","bUseTimeSpecification","sVATLiability","sVATNumber","sVatSystem","sViesLastCalledDate","sViesResult","sWebsite",
        "sWithholdingTaxDescription","sWithholdingTaxKey"
    };

    private static readonly string[] SalesOrderFields = new[] { "sBusinessComponent", "sEntityEvent",
        "iActionCheckBlockedAccount","iActionFinalUpdate","iActionMode","nAmountDC","nAmountDiscountFC","nAmountFC","nAmountVATDiscountFC",
        "nAmountVATFC","dApprovalDateTime","gCopyEntryID","sCurrency","gDeliveryAccount","sDeliveryAccountCode","gDeliveryAccountContact",
        "sDeliveryAccountName","gDeliveryAddress","dDeliveryDate","nDepositChargeAmountDC","nDepositChargeAmountFC","nDepositChargeAmountVATFC",
        "sDescription","nDiscount","nDiscountAmountDC","nDiscountAmountFC","iDiscountType","iDivision","sDivisionName","dEntryDate","gEntryID",
        "nEnvironmentalTaxChargeAmountDC","nEnvironmentalTaxChargeAmountFC","nEnvironmentalTaxChargeAmountVATFC","gExchangeRateType","gID",
        "gInvoiceAccount","sInvoiceAccountCode","iInvoiceAccountCodeFilled","gInvoiceAccountContact","sInvoiceAccountName","iInvoiceStatus",
        "sInvoiceStatusDescription","iInvoiceStatusDescriptionTermID","iLineNumber","gOrderAccount","sOrderAccountCode","gOrderAccountContact",
        "sOrderAccountName","sPaymentCondition","sPaymentConditionDescription","nRateFC","iSalesOrderNumber","iShippingStatus","sShippingStatusDescription",
        "iShippingStatusDescriptionTermID","iSource","iStatus","iStatusApproval","sStatusDescription","iStatusDescriptionTermID","dSyscreated","gSyscreator",
        "sSyscreatorFullName","dSysmodified","gSysmodifier","sSysmodifierFullName","iType","gWarehouse","sWarehouseCode","sYourRef"
    };

    private static readonly string[] ProjectFields = new[] { "sBusinessComponent", "sEntityEvent",
        "gAccount","gAccountContact","sAccountName","iActionCopy","bAllowAdditionalInvoicing","bAllowMemberEntryOnly","bBlockEntry",
        "bBlockPlanning","bBlockPurchasing","bBlockRebilling","iBudgetedHoursOverrunAction","iBudgetType","sBudgetTypeDescription",
        "sCode","dCreated","gCreator","sCreatorFullName","sCustomerPOnumber","sDescription","iDescriptionTermID","iDivision","sDivisionName","gID",
        "bIncludeSpecificationInInvoicePdf","bInvoiceAsQuoted","gManager","sManagerFullname","dModified","gModifier","sModifierFullName",
        "nPrepaidType","dStartDate","dTimeSpecificationType","iType","sTypeDescription","bUseBillingMilestones"
    };
}
