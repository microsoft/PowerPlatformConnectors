...
You need an Airtable Personal Access Token. Create one at [https://airtable.com/create/tokens/new](https://airtable.com/create/tokens/new) with the scopes listed in Prerequisites above.
