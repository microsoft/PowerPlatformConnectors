...
A LanguageTool Premium subscription with API access. You connect using your account **Username** and **API key**.
...
- This connector uses authenticated (account-based) access against `api.languagetoolplus.com`. The rules, suggestions, and rate limits available depend on your LanguageTool plan.
